# @generated by usage-argv for `rsplug __complete_word__ --shell fish`

function __usage_complete_rsplug
    ...
    set -l out (command 'rsplug' __complete_word__ --shell fish --line "$line" 2>/dev/null)
...
complete -c 'rsplug' -f -a '(__usage_complete_rsplug)'
