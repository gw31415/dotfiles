...
complete -c opencode2 -n '__fish_use_subcommand' -f -a 'upgrade' -d 'Upgrade OpenCode to the latest or a specific version'
...
complete -c opencode2 -n '__fish_use_subcommand; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
...
complete -c opencode2 -n '__fish_use_subcommand; and begin; not __fish_contains_opt -s s session; or contains -- (commandline -poc)[-1] --session -s; end' -l session -s s -d 'Session ID to continue' -r -f
complete -c opencode2 -n '__fish_use_subcommand; and begin; not __fish_contains_opt prompt; or contains -- (commandline -poc)[-1] --prompt; end' -l prompt -d 'Prompt to use' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from upgrade' -f
complete -c opencode2 -n '__fish_seen_subcommand_from upgrade; and begin; not __fish_contains_opt -s m method; or contains -- (commandline -poc)[-1] --method -m; end' -l method -s m -d 'Installation method to use' -r -f -a 'curl npm pnpm bun yarn'
complete -c opencode2 -n '__fish_seen_subcommand_from upgrade; and not string match -q -- "-*" (commandline -ct); and not __fish_contains_opt -s m method' -f -a '--method' -d 'Installation method to use'
...
complete -c opencode2 -n '__fish_seen_subcommand_from api; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from api; and begin; not __fish_contains_opt -s d data; or contains -- (commandline -poc)[-1] --data -d; end' -l data -s d -d 'Request body' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from api; and begin; not __fish_contains_opt -s H header; or contains -- (commandline -poc)[-1] --header -H; end' -l header -s H -d 'Request header in name:value form' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from api; and begin; not __fish_contains_opt param; or contains -- (commandline -poc)[-1] --param; end' -l param -d 'OpenAPI path or query parameter' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from debug; and not __fish_seen_subcommand_from agents config paths' -f
complete -c opencode2 -n '__fish_seen_subcommand_from debug; and not __fish_seen_subcommand_from agents config paths' -f -a 'agents' -d 'List all agents'
complete -c opencode2 -n '__fish_seen_subcommand_from debug; and not __fish_seen_subcommand_from agents config paths' -f -a 'config' -d 'List configuration sources'
complete -c opencode2 -n '__fish_seen_subcommand_from debug; and not __fish_seen_subcommand_from agents config paths' -f -a 'paths' -d 'Show global paths (data, config, cache, state)'
...
complete -c opencode2 -n '__fish_seen_subcommand_from debug; and __fish_seen_subcommand_from paths' -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from auth; and __fish_seen_subcommand_from list; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from auth; and __fish_seen_subcommand_from list; and begin; not __fish_contains_opt format; or contains -- (commandline -poc)[-1] --format; end' -l format -d 'Output format' -r -f -a 'default json'
...
complete -c opencode2 -n '__fish_seen_subcommand_from auth; and __fish_seen_subcommand_from login; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from auth; and __fish_seen_subcommand_from login; and begin; not __fish_contains_opt method; or contains -- (commandline -poc)[-1] --method; end' -l method -d 'Authentication method ID' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from auth; and __fish_seen_subcommand_from logout; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from mcp; and __fish_seen_subcommand_from add; and begin; not __fish_contains_opt url; or contains -- (commandline -poc)[-1] --url; end' -l url -d 'URL for a remote MCP server' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from mcp; and __fish_seen_subcommand_from add; and begin; not __fish_contains_opt header; or contains -- (commandline -poc)[-1] --header; end' -l header -d 'HTTP header for a remote server, as name=value' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from mcp; and __fish_seen_subcommand_from add; and begin; not __fish_contains_opt env; or contains -- (commandline -poc)[-1] --env; end' -l env -d 'Environment variable for a local server, as name=value' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from plugin; and not __fish_seen_subcommand_from list add check update remove' -f
complete -c opencode2 -n '__fish_seen_subcommand_from plugin; and not __fish_seen_subcommand_from list add check update remove' -f -a 'list' -d 'List plugins'
complete -c opencode2 -n '__fish_seen_subcommand_from plugin; and not __fish_seen_subcommand_from list add check update remove' -f -a 'add' -d 'Install a plugin and add it to the global configuration'
complete -c opencode2 -n '__fish_seen_subcommand_from plugin; and not __fish_seen_subcommand_from list add check update remove' -f -a 'check' -d 'Check package plugins for updates'
complete -c opencode2 -n '__fish_seen_subcommand_from plugin; and not __fish_seen_subcommand_from list add check update remove' -f -a 'update' -d 'Update package plugins'
complete -c opencode2 -n '__fish_seen_subcommand_from plugin; and not __fish_seen_subcommand_from list add check update remove' -f -a 'remove' -d 'Remove a plugin from global configuration'
...
complete -c opencode2 -n '__fish_seen_subcommand_from plugin; and __fish_seen_subcommand_from check' -f
complete -c opencode2 -n '__fish_seen_subcommand_from plugin; and __fish_seen_subcommand_from update' -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from models; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from stats; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from stats; and begin; not __fish_contains_opt days; or contains -- (commandline -poc)[-1] --days; end' -l days -d 'Show the last N days; 0 means today' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from stats; and begin; not __fish_contains_opt year; or contains -- (commandline -poc)[-1] --year; end' -l year -d 'Show a calendar year' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from stats; and begin; not __fish_contains_opt project; or contains -- (commandline -poc)[-1] --project; end' -l project -d 'Filter by project ID, or use "." for the current project' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from stats; and begin; not __fish_contains_opt limit; or contains -- (commandline -poc)[-1] --limit; end' -l limit -d 'Number of rows in detailed sections' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from export; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from import; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from import; and begin; not __fish_contains_opt directory; or contains -- (commandline -poc)[-1] --directory; end' -l directory -d 'Directory in which to import the session' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from mini; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from mini; and begin; not __fish_contains_opt -s s session; or contains -- (commandline -poc)[-1] --session -s; end' -l session -s s -d 'Session ID to continue' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from mini; and begin; not __fish_contains_opt replay-limit; or contains -- (commandline -poc)[-1] --replay-limit; end' -l replay-limit -d 'Limit replay to the newest N messages (default: 200)' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from mini; and begin; not __fish_contains_opt -s m model; or contains -- (commandline -poc)[-1] --model -m; end' -l model -s m -d 'Model to use in the format provider/model' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from mini; and begin; not __fish_contains_opt agent; or contains -- (commandline -poc)[-1] --agent; end' -l agent -d 'Agent to use' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from mini; and begin; not __fish_contains_opt prompt; or contains -- (commandline -poc)[-1] --prompt; end' -l prompt -d 'Prompt to use' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from run; and begin; not __fish_contains_opt server; or contains -- (commandline -poc)[-1] --server; end' -l server -d 'Connect to a server URL instead of the background service' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from run; and begin; not __fish_contains_opt -s s session; or contains -- (commandline -poc)[-1] --session -s; end' -l session -s s -d 'Session ID to continue' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from run; and begin; not __fish_contains_opt -s m model; or contains -- (commandline -poc)[-1] --model -m; end' -l model -s m -d 'Model to use in the format provider/model#variant' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from run; and begin; not __fish_contains_opt agent; or contains -- (commandline -poc)[-1] --agent; end' -l agent -d 'Agent to use' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from run; and begin; not __fish_contains_opt format; or contains -- (commandline -poc)[-1] --format; end' -l format -d 'Output format' -r -f -a 'default json'
complete -c opencode2 -n '__fish_seen_subcommand_from run; and begin; not __fish_contains_opt -s f file; or contains -- (commandline -poc)[-1] --file -f; end' -l file -s f -d 'File to attach to the message' -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from run; and begin; not __fish_contains_opt title; or contains -- (commandline -poc)[-1] --title; end' -l title -d 'Session title' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from serve; and begin; not __fish_contains_opt hostname; or contains -- (commandline -poc)[-1] --hostname; end' -l hostname -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from serve; and begin; not __fish_contains_opt port; or contains -- (commandline -poc)[-1] --port; end' -l port -r -f
complete -c opencode2 -n '__fish_seen_subcommand_from serve; and begin; not __fish_contains_opt cors; or contains -- (commandline -poc)[-1] --cors; end' -l cors -d 'Additional allowed CORS origin (repeat for multiple origins)' -r -f
...
complete -c opencode2 -n '__fish_seen_subcommand_from serve; and not string match -q -- "-*" (commandline -ct); and not __fish_contains_opt cors' -f -a '--cors' -d 'Additional allowed CORS origin (repeat for multiple origins)'
