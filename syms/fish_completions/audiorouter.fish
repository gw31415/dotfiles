...
complete -c audiorouter -n "__fish_audiorouter_using_subcommand help; and not __fish_seen_subcommand_from run check list-devices config-path completions help" -f -a "run" -d 'Start audio routing (default when no subcommand is given)'
complete -c audiorouter -n "__fish_audiorouter_using_subcommand help; and not __fish_seen_subcommand_from run check list-devices config-path completions help" -f -a "check" -d 'Validate configuration and device availability, then exit'
complete -c audiorouter -n "__fish_audiorouter_using_subcommand help; and not __fish_seen_subcommand_from run check list-devices config-path completions help" -f -a "list-devices" -d 'List available audio input/output devices, then exit'
complete -c audiorouter -n "__fish_audiorouter_using_subcommand help; and not __fish_seen_subcommand_from run check list-devices config-path completions help" -f -a "config-path" -d 'Print the resolved configuration path, then exit'
complete -c audiorouter -n "__fish_audiorouter_using_subcommand help; and not __fish_seen_subcommand_from run check list-devices config-path completions help" -f -a "completions" -d 'Generate a shell completion script'
complete -c audiorouter -n "__fish_audiorouter_using_subcommand help; and not __fish_seen_subcommand_from run check list-devices config-path completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
